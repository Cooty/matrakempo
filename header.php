...
<html class="no-js" lang="<?php bloginfo('language'); ?>">
    ...
    <script>
        var WebFontConfig = {
            google: {families: ['Roboto+Slab:700,400,300:latin-ext',
                                'Tinos:400,400italic,700,700italic:latin-ext'
                              ]}
        };
    </script>
    <script src="<?php bloginfo('template_directory')?>/js/lib/modernizr-2.7.2-custom.min.js" async></script>
    <script src="//ajax.googleapis.com/ajax/libs/webfont/1/webfont.js" async></script>        
    <noscript>
        <link href="http://fonts.googleapis.com/css?family=Roboto+Slab:400,700,300&amp;subset=latin-ext" rel="stylesheet">
        <link href="http://fonts.googleapis.com/css?family=Tinos:400,700,400italic,700italic&subset=latin-ext" rel="stylesheet">
        <style type="text/css">
